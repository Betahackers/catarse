...
# gem 'catarse_offline_payment', path: '../catarse_offline_payment'
gem 'catarse_offline_payment', github: 'Betahackers/catarse_offline_payment'
# gem 'catarse_paypal_adaptive', github: 'Betahackers/catarse_paypal_adaptive'
